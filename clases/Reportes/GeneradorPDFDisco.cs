...
{
    public class GeneradorPDFDisco : IGeneradorPDFDisco
    {
        private readonly ILogger<GeneradorPDFDisco> _logger;
        ...
        //};
        public GeneradorPDFDisco(ILogger<GeneradorPDFDisco> logger)
        {
            _logger = logger;
        ...
        public string CreateSamplePDf()
        {
            try
            {
                ...
                //C:\Generacion_Datasets\Economicos\
        ...
        public string CreateSamplePDf_Parametros(int DatasetElegido)
        {
            try
            {
                ...
                //===============================Declare file Path, Name of file, font and colours=========================================================
                //C:\Generacion_Datasets\Economicos\
                // pdfPathFolder = "C:/PdfFolder";
                if (!Directory.Exists(pdfPathFolder))
                {
                    Directory.CreateDirectory(pdfPathFolder);
                }
                string fileName = "Impuestos" + DateTime.Now.ToString("dd-MM-yyTHHmm") + ".pdf";
                string fullFilePath = System.IO.Path.Combine(pdfPathFolder, fileName);
                PdfFont font = PdfFontFactory.CreateFont(StandardFonts.HELVETICA, PdfEncodings.CP1252, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
                DeviceRgb purpleColour = new(128, 0, 128);
                DeviceRgb offPurpleColour = new(230, 230, 250);
    ...
    public class PDFHeaderEventHandler : IEventHandler
    {
        public void HandleEvent(Event currentEvent)
        {
            try
            {
                ...
                string logoPath = "C:\\Users\\roman\\source\\repos\\romansad\\Proyecto_Cristal_2022\\ClientApp\\src\\assets\\Imagenes\\Arcoiris.png";

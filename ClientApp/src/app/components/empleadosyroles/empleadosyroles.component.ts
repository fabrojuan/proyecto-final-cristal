...
@Component({
  selector: 'empleadosyroles',
  templateUrl: './empleadosyroles.component.html',
  styleUrls: ['./empleadosyroles.component.css']
})
export class EmpleadosyrolesComponent implements OnInit {
  idEmpleado: any;
  nombreEmpleado: any;
  chartDenuncia: any;
  totalDenuncias: any;

...
@Component({
  selector: 'tasas-impositivas',
  templateUrl: './tasas-impositivas.component.html',
  styleUrls: ['./tasas-impositivas.component.css']
})
export class TasasImpositivasComponent implements OnInit {
